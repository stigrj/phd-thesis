...
For instance, it is known that the ground state wave function is continuous, but not differentiable 
...
Due to the high cost of real-space methods, applications in electronic structrure 
